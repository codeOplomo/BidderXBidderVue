        ...
        <div :class="['sidebar', { 'is-collapsed': isSidebarCollapsed }]">
            <nav class="navbar bg-light navbar-light">
              ...
              <div class="navbar-nav w-100">
                <router-link to="/profile" class="nav-item nav-link"><i class="fa fa-user-circle me-2"></i>Profile</router-link>
                <router-link to="/profile-duplicate" class="nav-item nav-link"><i class="fa fa-user-circle me-2"></i>Profile</router-link>
